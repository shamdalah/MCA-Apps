...
<head>
    ...
    <title>Welcome To Mawar Car Audio Apps</title>
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php if ($level==1){ echo 'Admin';}else if ($level==2){echo 'Kasir';}?></td>
                        <td><?php if ($status==1){ echo 'Aktif';}else if ($status==0){echo 'Tidak Aktif';}?></td>                        
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/pengguna/tambah_pengguna'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="telpon" class="form-control" type="text" placeholder="No Telpon..." style="width:280px;" required>
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="user_email" class="form-control" type="email" placeholder="Email Anda..." style="width:280px;" required>
                        </div>
                    </div> 
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >No Telpon</label>
                        <div class="col-xs-9">
                            <input name="telpon" class="form-control" type="text" value="<?php echo $telpon;?>" placeholder="No Telpon..." style="width:280px;" required>
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Email</label>
                        <div class="col-xs-9">
                            <input name="user_email" class="form-control" type="email" value="<?php echo $email;?>" placeholder="Email Anda..." style="width:280px;" required>
                        </div>
                    </div>
